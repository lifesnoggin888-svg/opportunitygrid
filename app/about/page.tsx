  ...
  return (
    <>
      <section className="og-royal-section og-circuit">
        ...
        <div className="og-container relative py-16">
          <p className="og-reveal og-reveal-1 text-xs font-medium uppercase tracking-[0.18em] text-[var(--color-gold-soft)]">
            About this build
          </p>
          <h1 className="og-reveal og-reveal-2 font-serif mt-3 max-w-2xl text-2xl text-white md:text-3xl">
      ...
      <section className="og-container py-16">
        <div className="og-card mx-auto max-w-2xl space-y-6 p-8 text-sm leading-relaxed text-[var(--color-muted)] md:p-10">
          <p>
        ...
        <div className="mx-auto max-w-2xl">
          <Link href="/opportunities" className="og-btn-primary mt-10">
